            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-stretch">
                ...
                <div class="text-center md:text-left">
                    <h1 class="font-sans text-4xl md:text-5xl lg:text-6xl font-bold text-gray-800 leading-tight mb-4">
                        ADHD Telehealth Testing <span class="text-blue-600">Across California</span>
                    </h1>
                ...
                <!-- Right Column: Image -->
                <div class="rounded-lg shadow-lg w-full h-[400px] md:h-[500px] overflow-hidden">
        ...
        <div class="container mx-auto px-4 max-w-7xl">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-6 md:gap-6">
                <?php foreach ($cities as $city) : ?>
                    ...
                    <a href="<?php echo esc_url(home_url('/adhd-testing/' . $city_slug)); ?>" class="city-card block bg-slate-50 hover:bg-slate-100 p-8 rounded-lg shadow-sm hover:shadow-md transition-all duration-300 text-center">
